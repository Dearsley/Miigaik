def get_words(path=r"C:\Users\ganoh\PycharmProjects\Miigaik\wheel_of_fortune\words.txt"):
...
def get_records(record, path=r"C:\Users\ganoh\PycharmProjects\Miigaik\wheel_of_fortune\record.txt"):
